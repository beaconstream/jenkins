...
public class ProfileCardAdapter extends RecyclerView.Adapter<ProfileCardAdapter.ViewHolder> implements Filterable, View.OnClickListener {
    ...
    public ProfileCardAdapter(List<Home> items, Context context){
        super();
    ...
    @Override
    public void onBindViewHolder(final ProfileCardAdapter.ViewHolder holder, int position) {
            ...
            case R.id.editTextView_delete:
                ...
                try {
                    if(null!= AppConfig.getUser_id())
                    {
                        ...
                        jsonObject.put("id", AppConfig.home_Profile_List.get(selectedImagePosition).getPost_id());
                        AppConfig.home_Profile_List.remove(selectedImagePosition);
    ...
    public void onSwitch_UploadVideo(final ProfileCardAdapter.ViewHolder holder, Home list) {
