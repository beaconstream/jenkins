...
public abstract class BaseActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener  {
    ...
    public void intitialiseFragment_LeftToRightTransition_mediaType(Fragment selectedFragment){
    ...
    public void intitialiseFragment_LeftToRightTransition_friendsHeader(Fragment selectedFragment){
    ...
    public void intitialiseFragment_LeftToRightTransition_yourFriendsList(Fragment selectedFragment){
