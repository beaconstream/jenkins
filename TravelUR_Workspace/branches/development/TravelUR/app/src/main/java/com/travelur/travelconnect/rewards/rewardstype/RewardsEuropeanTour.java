...
import com.travelur.travelconnect.rewards.adapters.RewardsEuropeanTourAdapter;
...
public class RewardsEuropeanTour extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.rewards_europeantour_content_main, null, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new RewardsEuropeanTourAdapter(AppConfig.reward_europeantour_list, getContext());
    ...
    private void refreshContent() {
        ...
        try {
            if(null!=AppConfig.getUser_id())
            {
                ...
                volleyRequest.rewards(jsonObject, adapter, swipeRefreshLayout, tour_image, tour_name,1);
            }
