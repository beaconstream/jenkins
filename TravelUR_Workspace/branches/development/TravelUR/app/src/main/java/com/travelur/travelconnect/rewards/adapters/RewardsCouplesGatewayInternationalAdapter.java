...
public class RewardsCouplesGatewayInternationalAdapter  extends RecyclerView.Adapter<RewardsCouplesGatewayInternationalAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public RewardsCouplesGatewayInternationalAdapter(List<Rewards> rewardsList, Context context) {
        this.rewardsList = rewardsList;
        this.context = context;
    }

    @Override
    public RewardsCouplesGatewayInternationalAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.rewards_couplesgateway_international_item, parent, false);

        return new RewardsCouplesGatewayInternationalAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(RewardsCouplesGatewayInternationalAdapter.MyViewHolder holder, int position) {
