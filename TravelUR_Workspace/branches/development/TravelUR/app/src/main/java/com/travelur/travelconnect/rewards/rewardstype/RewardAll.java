...
import com.travelur.travelconnect.rewards.adapters.RewardsAdapter;
...
public class RewardAll extends BaseFragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.rewards_content_main, null, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new RewardsAdapter(AppConfig.reward_worldtour_list, getContext());
