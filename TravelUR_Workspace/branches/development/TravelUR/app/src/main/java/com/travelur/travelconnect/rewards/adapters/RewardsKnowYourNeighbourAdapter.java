...
public class RewardsKnowYourNeighbourAdapter  extends RecyclerView.Adapter<RewardsKnowYourNeighbourAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public RewardsKnowYourNeighbourAdapter(List<Rewards> rewardsList, Context context) {
        this.rewardsList = rewardsList;
        this.context = context;
    }

    @Override
    public RewardsKnowYourNeighbourAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.rewards_knowurneighbour_item, parent, false);

        return new RewardsKnowYourNeighbourAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(RewardsKnowYourNeighbourAdapter.MyViewHolder holder, int position) {
