...
public class MoreDetailsDetailedItenary extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.vacation_package_more_details_detaileditenary_content_main, null, false);
        return v;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new VacationPacekageMoreDetailsItenaryAdapter(vacationpackages_moredetails_detaileditenary_listitem, getContext());
    ...
    private void refreshContent() {
        ...
        try {
            if(null!= AppConfig.getUser_id())
            {
                ...
                volleyRequest.vacation_package_moreDetails_detailedItenary(jsonObject, adapter, swipeRefreshLayout);
            }
