...
public class RewardsCouplesGatewayDomestic extends BaseFragment  implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.rewards_couplesgateway_domestic_content_main, null, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new RewardsCouplesGatewayDomesticAdapter(AppConfig.reward_couplesgateway_domestic_list, getContext());
    ...
    private void refreshContent() {
        ...
        try {
            if(null!=AppConfig.getUser_id())
            {
                ...
                volleyRequest.rewards(jsonObject, adapter, swipeRefreshLayout, tour_image, tour_name, 3);
            }
