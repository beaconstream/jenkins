...
import com.travelur.travelconnect.rewards.rewardstype.rewardsmoredetailtype.RewardsMoreDetailsEuropeanTour;
import com.travelur.travelconnect.rewards.rewardstype.rewardsmoredetailtype.RewardsMoreDetailsKnowUrNeighbour;
import com.travelur.travelconnect.rewards.rewardstype.rewardsmoredetailtype.RewardsMoreDetailsLocalSplendors;
...
public class RewardsWorldTour extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.rewards_worldtour_content_main, null, false);
      if(tour_image.isEmpty() && tour_name.isEmpty())
      {
          tour_image.add(R.drawable.world_tour);
          tour_image.add(R.drawable.european_tour);
          tour_image.add(R.drawable.couples_gateway_international);
          tour_image.add(R.drawable.couples_gateaway_domestic);
          tour_image.add(R.drawable.know_ur_neighbour);
          tour_image.add(R.drawable.local_splendor_getaway);

          tour_name.add("World Tour");
          tour_name.add("European Tour");
          tour_name.add("Couples Getaway(International)");
          tour_name.add("Couples Getaway(Domestic)");
          tour_name.add("Know Your Neighbor Getaway");
          tour_name.add("Local Splendor Getaway");
      }
        return v;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new RewardsWorldTourAdapter(reward_worldtour_list, getContext());
                            ...
                            case 1:
                                button_more_details.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        switch(v.getId()){
                                            case R.id.button_more_details:
                                                selectedFragment = RewardsMoreDetailsEuropeanTour.newInstance();
                                                intitialiseFragment_LeftToRightTransition(selectedFragment);
                                                break;
                                        }
                                    }
                            ...
                            case 3:
                                button_more_details.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        switch(v.getId()){
                                            case R.id.button_more_details:
                                                selectedFragment = RewardsMoreDetailsCouplesGatewayDomestic.newInstance();
                                                intitialiseFragment_LeftToRightTransition(selectedFragment);
                                                break;
                                        }
                                    }
                            ...
                            case 5:
                                button_more_details.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        switch(v.getId()){
                                            case R.id.button_more_details:
                                                selectedFragment = RewardsMoreDetailsLocalSplendors.newInstance();
                                                intitialiseFragment_LeftToRightTransition(selectedFragment);
                                                break;
                                        }
                                    }
    ...
    private void refreshContent() {
        ...
        try {
            if(null!=AppConfig.getUser_id())
            {
                ...
                volleyRequest.rewards(jsonObject, adapter, swipeRefreshLayout, tour_image, tour_name, 0);
            }
