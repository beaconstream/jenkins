...
public class MainActivity extends BaseActivity implements NavigationDrawerFragment.DrawerListener, View.OnClickListener, BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    private TextView layout_Title, custom_toolbar_menu_item, profile_name;
    //ImageView profile_icon;
    private Button sign_out;
    private Toolbar toolbar;
    private FragmentManager fragmentManaager;
    ...
    private TextView groups, moreTextView_groups, destination, moreTextView_destination, rewards, moreTextView_rewards, alerts, moreTextView_alerts;

    private BottomNavigationView bottomNavigationView, bottomNavigationView_more, bottomNavigationView_trips;
