...
import com.travelur.travelconnect.rewards.adapters.RewardsLocalSplendorsAdapter;
...
public class RewardsLocalSplendors extends BaseFragment  implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.rewards_localsplendors_content_main, null, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new RewardsLocalSplendorsAdapter(AppConfig.reward_localsplendors_list, getContext());
    ...
    private void refreshContent() {
        ...
        try {
            if(null!=AppConfig.getUser_id())
            {
                ...
                volleyRequest.rewards(jsonObject, adapter, swipeRefreshLayout, tour_image, tour_name,5);
            }
